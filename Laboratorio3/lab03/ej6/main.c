...
/*La version con punteros funciona mas rapido que las que no los utiliza porque los punteros
trabajan con la memoria dinamica en vez de con la memoria estatica.
Si no estuviera la linea con el destroy, el espacio ocupado por los punteros en memoria dinamica
nunca se liberaria, por lo que estariamos ocupando espacion en la memoria dinamica el cual
no vamos a utilizar*/